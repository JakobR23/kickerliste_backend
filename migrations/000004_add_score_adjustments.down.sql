-- Reverse of 000004_add_score_adjustments.up.sql
-- Restore the view to its post-000003 state (approved filter, wins only, no adjustments).
...
DROP TABLE IF EXISTS score_adjustment;
